...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
    ...
    <title>.:: Frete Iepê ::.</title>
</head>
<body>
    {{--  Abrir formulário --}}
    {!! Form::open(['url' => '/cliente/return', 'method' => 'POST']) !!} 
    <form runat="server" class="form-inline"  autocomplete="off">
        <div id="main">
                ...
                <div id="content" >                    
                    ...
                    <div class="form-group mb-2" align="center">                           
                        <div class="form-group mx-sm-3 mb-2">                            
                            {!! Form::text('txtNome', null, ['class' => 'form-control', 'placeholder' => 'Nome:', 'maxlength' => 35, 'style' => 'width:350px;']) !!}
                        </div>                        
                        <!--<button class="btn"><i class="fa fa-home"></i><a class="btn btn-default btn-close" href="{{ url('cliente/return') }}">Consultar</a></button> -->
                        <button class="btn btn-primary" type="submit">{!! Form::submit('Consultar', ['class' => 'btn btn-primary', 'style' => 'width:100px;']) !!}</button>
            ...
            <div id="footer" class="box">
                <p class="f-left">&copy; 2019 FP Soluções Tecnológicas LTDA, Todos os direitos reservados &reg;</p>
